...
For accuracy of registered data please review and confirm the details provided. </h3>
    ...
    <div class="section">
        ...
        <h3>Please attach a soft copy of your VALID government-issued ID (GIID). <a href="#popup-giidlist" class="showPopup">SEE valid GIID List</a> | <a href="#" class="orange">file attached : drivers_license.jpg (50kb)</a> | <a href="#">delete</a></h3>
...
<h3>To continue with registration, please submit a copy of your GIID within seven (7) days. Failure to do so will restart </h3>
        ...
        <div class="row rowSubmit">
        	<input type="submit" value="CONFIRM" class="button btnRed"/>
        </div><!-- END .rowSubmit -->
        </form>
        <div class="step">
