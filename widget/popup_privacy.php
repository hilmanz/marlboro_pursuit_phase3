<div class="popup">
	<div class="popupContainer" id="popup-privacy">
        <div class="popupContent">
        	<div class="popup-title">
            	<h1>Privacy Statement AND CONSENT</h1>
            </div><!--END .entry-title-->
        	<div class="entry-popup">
            <p>We at PM respect the privacy of our consumers. We are committed to appropriately safeguarding personal information that you provide to us when you visit and use the Website. This section includes a description of the types of personal information we collect via the Website and your consent on how we can use it. It also describes the measures we take to protect the security of the information and how you can contact us. </p>
